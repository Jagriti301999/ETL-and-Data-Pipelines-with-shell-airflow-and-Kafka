...
unzip_data = BashOperator(
    task_id = 'unzip_data',
    bash_command = 'tar -xzf /home/project/airflow/dags/assignment/dagdata.tgz',
    dag = dag 
)
...
unzip_data >> extract_csv_data >> extract_tsv_data >> extract_data_from_fixed_width >> consolidate_data >> transformed_data
